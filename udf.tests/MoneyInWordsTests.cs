...
public class ДеньгиПрописьюТесты {
    ...
    public static IEnumerable<object[]> ПримерыДенег => new[] {
        new object[] { 0.0, "ноль рублей 00 копеек" },
        new object[] { 0.01, "ноль рублей 01 копейка" },
        new object[] { 1.00, "один рубль 00 копеек" },
        new object[] { 2.02, "два рубля 02 копейки" },
        new object[] { 3.03, "три рубля 03 копейки" },
        new object[] { 4.04, "четыре рубля 04 копейки" },
        new object[] { 5.05, "пять рублей 05 копеек" },
        new object[] { 6.06, "шесть рублей 06 копеек" },
        new object[] { 7.07, "семь рублей 07 копеек" },
        new object[] { 8.08, "восемь рублей 08 копеек" },
        new object[] { 9.09, "девять рублей 09 копеек" },
        new object[] { 10.1, "десять рублей 10 копеек" },
        new object[] { 11.11, "одиннадцать рублей 11 копеек" },
        new object[] { 12.12, "двенадцать рублей 12 копеек" },
        new object[] { 13.13, "тринадцать рублей 13 копеек" },
        new object[] { 14.14, "четырнадцать рублей 14 копеек" },
        new object[] { 15.15, "пятнадцать рублей 15 копеек" },
        new object[] { 16.16, "шестнадцать рублей 16 копеек" },
        new object[] { 17.17, "семнадцать рублей 17 копеек" },
        new object[] { 18.18, "восемнадцать рублей 18 копеек" },
        new object[] { 19.19, "девятнадцать рублей 19 копеек" },
        new object[] { 20.2, "двадцать рублей 20 копеек" },
        ...
        new object[] { 29.29, "двадцать девять рублей 29 копеек" },
        new object[] { 30.3, "тридцать рублей 30 копеек" },
        ...
        new object[] { 39.39, "тридцать девять рублей 39 копеек" },
        new object[] { 40.4, "сорок рублей 40 копеек" },
        new object[] { 41.41, "сорок один рубль 41 копейка" },
        new object[] { 42.42, "сорок два рубля 42 копейки" },
        new object[] { 43.43, "сорок три рубля 43 копейки" },
        new object[] { 44.44, "сорок четыре рубля 44 копейки" },
        new object[] { 45.45, "сорок пять рублей 45 копеек" },
        new object[] { 46.46, "сорок шесть рублей 46 копеек" },
        new object[] { 47.47, "сорок семь рублей 47 копеек" },
        new object[] { 48.48, "сорок восемь рублей 48 копеек" },
        new object[] { 49.49, "сорок девять рублей 49 копеек" },
        new object[] { 50.5, "пятьдесят рублей 50 копеек" },
        ...
        new object[] { 70.7, "семьдесят рублей 70 копеек" },
        new object[] { 71.71, "семьдесят один рубль 71 копейка" },
        ...
        new object[] { 90.9, "девяносто рублей 90 копеек" },
        new object[] { 91.91, "девяносто один рубль 91 копейка" },
        ...
        new object[] { 99.99, "девяносто девять рублей 99 копеек" },
        new object[] { 100.00, "сто рублей 00 копеек" },
        new object[] { 101.00, "сто один рубль 00 копеек" },
        new object[] { 110.00, "сто десять рублей 00 копеек" },
    ...
    public static IEnumerable<object[]> ПримерыКлассаЧисла => new[] {
        new object[] { (ushort)0, "ноль", true },
        new object[] { (ushort)1, "один", true },
        new object[] { (ushort)2, "два", true },
        new object[] { (ushort)1, "одна", false },
        new object[] { (ushort)2, "две", false },
        new object[] { (ushort)3, "три", true },
        new object[] { (ushort)4, "четыре", true },
        new object[] { (ushort)3, "три", false },
        new object[] { (ushort)4, "четыре", false },
        new object[] { (ushort)5, "пять", true },
        new object[] { (ushort)6, "шесть", true },
        new object[] { (ushort)7, "семь", true },
        new object[] { (ushort)8, "восемь", true },
        new object[] { (ushort)9, "девять", true },
        new object[] { (ushort)10, "десять", true },
        new object[] { (ushort)11, "одиннадцать", true },
        new object[] { (ushort)12, "двенадцать", true },
        new object[] { (ushort)13, "тринадцать", true },
        new object[] { (ushort)14, "четырнадцать", true },
        new object[] { (ushort)15, "пятнадцать", true },
        new object[] { (ushort)16, "шестнадцать", true },
        new object[] { (ushort)17, "семнадцать", true },
        new object[] { (ushort)18, "восемнадцать", true },
        new object[] { (ushort)19, "девятнадцать", true },
        new object[] { (ushort)20, "двадцать", true },
        new object[] { (ushort)21, "двадцать один", true },
        new object[] { (ushort)22, "двадцать два", true },
        new object[] { (ushort)23, "двадцать три", true },
        new object[] { (ushort)24, "двадцать четыре", true },
        new object[] { (ushort)25, "двадцать пять", true },
        new object[] { (ushort)26, "двадцать шесть", true },
        new object[] { (ushort)27, "двадцать семь", true },
        new object[] { (ushort)28, "двадцать восемь", true },
        new object[] { (ushort)29, "двадцать девять", true },
        new object[] { (ushort)30, "тридцать", true },
        new object[] { (ushort)31, "тридцать один", true },
        new object[] { (ushort)32, "тридцать два", true },
        new object[] { (ushort)33, "тридцать три", true },
        new object[] { (ushort)34, "тридцать четыре", true },
        new object[] { (ushort)35, "тридцать пять", true },
        new object[] { (ushort)36, "тридцать шесть", true },
        new object[] { (ushort)37, "тридцать семь", true },
        new object[] { (ushort)38, "тридцать восемь", true },
        new object[] { (ushort)39, "тридцать девять", true },
        new object[] { (ushort)40, "сорок", true },
        new object[] { (ushort)41, "сорок один", true },
        new object[] { (ushort)42, "сорок два", true },
        new object[] { (ushort)43, "сорок три", true },
        new object[] { (ushort)44, "сорок четыре", true },
        new object[] { (ushort)45, "сорок пять", true },
        new object[] { (ushort)46, "сорок шесть", true },
        new object[] { (ushort)47, "сорок семь", true },
        new object[] { (ushort)48, "сорок восемь", true },
        new object[] { (ushort)49, "сорок девять", true },
        new object[] { (ushort)50, "пятьдесят", true },
        new object[] { (ushort)51, "пятьдесят один", true },
        new object[] { (ushort)52, "пятьдесят два", true },
        new object[] { (ushort)53, "пятьдесят три", true },
        new object[] { (ushort)54, "пятьдесят четыре", true },
        new object[] { (ushort)55, "пятьдесят пять", true },
        new object[] { (ushort)56, "пятьдесят шесть", true },
        new object[] { (ushort)57, "пятьдесят семь", true },
        new object[] { (ushort)58, "пятьдесят восемь", true },
        new object[] { (ushort)59, "пятьдесят девять", true },
        new object[] { (ushort)60, "шестьдесят", true },
        new object[] { (ushort)61, "шестьдесят один", true },
        new object[] { (ushort)62, "шестьдесят два", true },
        new object[] { (ushort)63, "шестьдесят три", true },
        new object[] { (ushort)64, "шестьдесят четыре", true },
        new object[] { (ushort)65, "шестьдесят пять", true },
        new object[] { (ushort)66, "шестьдесят шесть", true },
        new object[] { (ushort)67, "шестьдесят семь", true },
        new object[] { (ushort)68, "шестьдесят восемь", true },
        new object[] { (ushort)69, "шестьдесят девять", true },
        new object[] { (ushort)70, "семьдесят", true },
        new object[] { (ushort)71, "семьдесят один", true },
        new object[] { (ushort)72, "семьдесят два", true },
        new object[] { (ushort)73, "семьдесят три", true },
        new object[] { (ushort)74, "семьдесят четыре", true },
        new object[] { (ushort)75, "семьдесят пять", true },
        new object[] { (ushort)76, "семьдесят шесть", true },
        new object[] { (ushort)77, "семьдесят семь", true },
        new object[] { (ushort)78, "семьдесят восемь", true },
        new object[] { (ushort)79, "семьдесят девять", true },
        new object[] { (ushort)80, "восемьдесят", true },
        new object[] { (ushort)81, "восемьдесят один", true },
        new object[] { (ushort)82, "восемьдесят два", true },
        new object[] { (ushort)83, "восемьдесят три", true },
        new object[] { (ushort)84, "восемьдесят четыре", true },
        new object[] { (ushort)85, "восемьдесят пять", true },
        new object[] { (ushort)86, "восемьдесят шесть", true },
        new object[] { (ushort)87, "восемьдесят семь", true },
        new object[] { (ushort)88, "восемьдесят восемь", true },
        new object[] { (ushort)89, "восемьдесят девять", true },
        new object[] { (ushort)90, "девяносто", true },
        new object[] { (ushort)91, "девяносто один", true },
        new object[] { (ushort)92, "девяносто два", true },
        new object[] { (ushort)93, "девяносто три", true },
        new object[] { (ushort)94, "девяносто четыре", true },
        new object[] { (ushort)95, "девяносто пять", true },
        new object[] { (ushort)96, "девяносто шесть", true },
        new object[] { (ushort)97, "девяносто семь", true },
        new object[] { (ushort)98, "девяносто восемь", true },
        new object[] { (ushort)99, "девяносто девять", true },
        new object[] { (ushort)100, "сто", true },
        new object[] { (ushort)101, "сто один", true },
        new object[] { (ushort)101, "сто одна", false },
        new object[] { (ushort)102, "сто два", true },
        new object[] { (ushort)102, "сто две", false },
        ...
        new object[] { (ushort)890, "восемьсот девяносто", true },
        new object[] { (ushort)901, "девятьсот один", true },
    ...
    public static IEnumerable<object[]> ПримерыЦелыхЧиселТысячи {
        get {
            ...
            var замена1 = "одна";
            var замена2 = "две";
            var заменитьРод = (string число) => Regex.Replace(
                Regex.Replace(число, шаблон1, замена1), шаблон2, замена2
            );
    ...
    public static IEnumerable<object[]> ПримерыВалютОсновный => new[] {
        new object[] { 0.0m, "рублей" },
        new object[] { 1.0m, "рубль" },
        new object[] { 2.0m, "рубля" },
        new object[] { 3.0m, "рубля" },
        new object[] { 4.0m, "рубля" },
        new object[] { 5.0m, "рублей" },
        new object[] { 6.0m, "рублей" },
        new object[] { 7.0m, "рублей" },
        new object[] { 8.0m, "рублей" },
        new object[] { 9.0m, "рублей" },
        new object[] { 10.0m, "рублей" },
        new object[] { 11.0m, "рублей" },
        new object[] { 12.0m, "рублей" },
        new object[] { 13.0m, "рублей" },
        new object[] { 14.0m, "рублей" },
        new object[] { 15.0m, "рублей" },
        new object[] { 16.0m, "рублей" },
        new object[] { 17.0m, "рублей" },
        new object[] { 18.0m, "рублей" },
        new object[] { 19.0m, "рублей" },
        new object[] { 20.0m, "рублей" },
        new object[] { 21.0m, "рубль" },
        new object[] { 32.0m, "рубля" },
        new object[] { 43.0m, "рубля" },
        new object[] { 34.0m, "рубля" },
        new object[] { 35.0m, "рублей" },
        new object[] { 1_000m, "рублей" },
        new object[] { 1_001m, "рубль" },
        new object[] { 1_010m, "рублей" },
        new object[] { 1_021m, "рубль" },
        new object[] { 1_000_000_000m, "рублей" }
    };

    public static IEnumerable<object[]> ПримерыВалютДробной => new[] {
        new object[] { .00m, "копеек" },
        new object[] { .01m, "копейка" },
        new object[] { .02m, "копейки" },
        new object[] { .03m, "копейки" },
        new object[] { .04m, "копейки" },
        new object[] { .05m, "копеек" },
        new object[] { .06m, "копеек" },
        new object[] { .07m, "копеек" },
        new object[] { .08m, "копеек" },
        new object[] { .09m, "копеек" },
        new object[] { .100m, "копеек" },
        new object[] { .110m, "копеек" },
        new object[] { .120m, "копеек" },
        new object[] { .130m, "копеек" },
        new object[] { .140m, "копеек" },
        new object[] { .150m, "копеек" },
        new object[] { .160m, "копеек" },
        new object[] { .170m, "копеек" },
        new object[] { .180m, "копеек" },
        new object[] { .190m, "копеек" },
        new object[] { .200m, "копеек" },
        new object[] { .210m, "копейка" },
        new object[] { .220m, "копейки" },
        new object[] { .230m, "копейки" },
        new object[] { .240m, "копейки" },
        new object[] { .250m, "копеек" }
    };

    [Theory]
    [MemberData(nameof(ПримерыДенег))]
    public void ВозможныйФормат(double число, string текст) {
        РублиПрописью(число, "бт р д2 к").Should().Be(текст);
    }
