...
public sealed partial class ДеньгиПрописью {
    ...
    public class ЧислоЦелоеКласс {
        ...
        public string ПреобразуйВТекст(bool родМужскойЛи = true) {
            if (Справочник.ДайНазваниеИменногоЧисла(Цифры, родМужскойЛи) is { } числоЦеликом)
                return числоЦеликом;
            ...
            if (!string.IsNullOrEmpty(десЕд))
                return string.Join(' ', сотни, десЕд);
